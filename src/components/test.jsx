...
const CarFilter = ({ onFilterChange }) => {
   ...
   const [showFilters, setShowFilters] = useState(false); // État pour contrôler l'affichage des filtres
   ...
   return (
      <div className="container">
         ...
         {/* Bouton "Filtre" visible uniquement sur les petits écrans */}
         <div className="d-md-none text-center mb-3">
            <button className="btn btn-secondary" onClick={toggleFilters}>
               <div className="d-flex" style={{ paddingLeft: "0rem" }}>

                  <svg data-name="Layer 1" style={{ margin: '0px 5px 0px', color: "#fff", width: '18px' }} id="Layer_1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                     <title />
                     <path d="M47,12a2,2,0,0,0-2-2H24a2,2,0,0,0,0,4H45A2,2,0,0,0,47,12Z" fill="white" />
                     <path d="M3,14H8.35a6,6,0,1,0,0-4H3a2,2,0,0,0,0,4Zm11-4a2,2,0,1,1-2,2A2,2,0,0,1,14,10Z" fill="white" />
                     <path d="M45,22H37.65a6,6,0,1,0,0,4H45a2,2,0,0,0,0-4ZM32,26a2,2,0,1,1,2-2A2,2,0,0,1,32,26Z" fill="white" />
                     <path d="M22,22H3a2,2,0,0,0,0,4H22a2,2,0,0,0,0-4Z" fill="white" />
                     <path d="M45,34H28a2,2,0,0,0,0,4H45a2,2,0,0,0,0-4Z" fill="white" />
                     <path d="M18,30a6,6,0,0,0-5.65,4H3a2,2,0,0,0,0,4h9.35A6,6,0,1,0,18,30Zm0,8a2,2,0,1,1,2-2A2,2,0,0,1,18,38Z" fill="white" />
                  </svg>


                  {!showFilters ? "Filtrer" : 'Fermer'}
         ...
         {/* Filtres avancés encapsulés dans une boîte, affichés ou cachés sur mobile */}
         {(showFilters || window.innerWidth >= 768) && ( // Afficher les filtres sur les grands écrans ou si showFilters est vrai
